...
namespace WintabDN
{
    ...
    public class CWintabInfo
    {
        ...
        public static bool IsWintabAvailable()
        {
            ...
            {
                Console.WriteLine("FAILED IsWintabAvailable: " + ex.ToString());
            }
        ...
        public static String GetDeviceInfo()
        {
            ...
            {
                Console.WriteLine("FAILED GetDeviceInfo: " + ex.ToString());
            }
        ...
        private static CWintabContext GetDefaultContext(EWTICategoryIndex contextIndex_I)
        {
            ...
            {
                Console.WriteLine("FAILED GetDefaultContext: " + ex.ToString());
            }
        ...
        public static Int32 GetDefaultDeviceIndex()
        {
            ...
            {
                Console.WriteLine("FAILED GetDefaultDeviceIndex: " + ex.ToString());
            }
        ...
        public static WintabAxis GetDeviceAxis(Int32 devIndex_I, EAxisDimension dim_I)
        {
            ...
            {
                Console.WriteLine("FAILED GetDeviceAxis: " + ex.ToString());
            }
        ...
        public static WintabAxisArray GetDeviceOrientation(out bool tiltSupported_O)
        {
            ...
            {
                Console.WriteLine("FAILED GetDeviceOrientation: " + ex.ToString());
            }
        ...
        public static WintabAxisArray GetDeviceRotation(out bool rotationSupported_O)
        {
            ...
            {
                Console.WriteLine("FAILED GetDeviceRotation: " + ex.ToString());
            }
        ...
        public static UInt32 GetNumberOfDevices()
        {
            ...
            {
                Console.WriteLine("FAILED GetNumberOfDevices: " + ex.ToString());
            }
        ...
        public static Int32 GetMaxPressure(bool getNormalPressure_I = true)
        {
            ...
            {
                Console.WriteLine("FAILED GetMaxPressure: " + ex.ToString());
            }
        ...
        public static UInt32 GetNumberOfConfiguredDevices()
        {
            ...
            {
                Console.WriteLine("FAILED GetNumberOfConfiguredDevices: " + ex.ToString());
            }
