...
namespace WintabDN
{
    ...
    public class CWintabData
    {
        ...
        private void Init(CWintabContext context_I)
        {
            ...
            {
                Console.WriteLine("FAILED CWintabData.Init: " + ex.ToString());
            }
        }
        ...
        public bool SetPacketQueueSize(UInt32 numPkts_I)
        {
            ...
            {
                Console.WriteLine("FAILED SetPacketQueueSize: " + ex.ToString());
            }
        ...
        public UInt32 GetPacketQueueSize()
        {
            ...
            {
                Console.WriteLine("FAILED GetPacketQueueSize: " + ex.ToString());
            }
        ...
        public void BringToFront()
        {
            ...
            {
                Console.WriteLine("FAILED BringToFront: " + ex.ToString());
            }
        }
        ...
        public WintabPacketExt GetDataPacketExt(UInt32 hCtx_I, UInt32 pktID_I)
        {
            ...
            {
                Console.WriteLine("FAILED GetDataPacketExt: " + ex.ToString());
            }
        ...
        public void FlushDataPackets(uint numPacketsToFlush_I)
        {
            ...
            {
                Console.WriteLine("FAILED GetPacketDataRange: " + ex.ToString());
            }
        }
