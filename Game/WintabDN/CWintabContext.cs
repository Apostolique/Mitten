...
namespace WintabDN
{
    ...
    public class CWintabContext
    {
        ...
        public HCTX Open(HWND hwnd_I, bool enable_I)
        {
            ...
            {
                Console.WriteLine("FAILED OpenContext: " + ex.ToString());
            }
        ...
        public bool Close()
        {
            ...
            {
                Console.WriteLine("FAILED CloseContext: " + ex.ToString());
            }
        ...
        public bool Enable(bool enable_I)
        {
            ...
            {
                Console.WriteLine("FAILED EnableContext: " + ex.ToString());
            }
        ...
        public bool SetOverlapOrder(bool toTop_I)
        {
            ...
            {
                Console.WriteLine("FAILED SetContextOverlapOrder: " + ex.ToString());
            }
